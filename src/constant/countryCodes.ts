// Comprehensive list of countries with ISO2 and dial codes
// Keep sorted by country name

export type CountryDialCode = {
	name: string;
	iso2: string; // ISO 3166-1 alpha-2
	dialCode: string; // E.164 dial prefix with leading +
};
...
export const isoToDialMap: Record<string, string> = COUNTRY_CODES.reduce(
	(map, c) => {
		map[c.iso2] = c.dialCode;
		return map;
	},
